...
import { Sparkles, ImageIcon, Calendar, BarChart3, Settings, LogOut, Users } from 'lucide-react';
...
const Dashboard = () => {
  ...
  const sidebarItems = [
    ...
    { id: 'design', icon: ImageIcon, label: 'Design Studio' },
        ...
        return (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Create stunning visuals for your social media posts</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-96 bg-gradient-to-br from-green-100 to-green-200 rounded-lg flex items-center justify-center">
                <p className="text-green-600 font-medium">Design tools coming soon...</p>
              </div>
            </CardContent>
          </Card>
        );
